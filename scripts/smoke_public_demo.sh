    ...
    try:
        checks = {
            "/": (
                ...
                "#relations",
                "What can I do here?",
                "Use this project as a local work surface",
                "Recommended next",
                "Current work state",
                "Start here before handing work to an agent",
                "Needs attention",
                "Waiting for review",
                "Latest status",
                "Read latest status",
            ...
            "/projects/central-agent-data-hub-demo?lang=de": (
                ...
                "Nutze dieses Projekt als lokale Arbeitsfläche",
                "Empfohlen",
                "Aktueller Arbeitsstand",
                "Beginne hier, bevor du Arbeit an einen Agenten übergibst",
