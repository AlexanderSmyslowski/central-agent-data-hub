    ...
    try:
        checks = {
            ...
            "/": (
                ...
                "Pick one path: read the current project state, review suggested memory changes, or prepare context for an agent.",
                "Understand the project",
                "Read project state",
                "Open the project state with latest status, risks, questions, and reviewed memory.",
                "Human review",
                "Accept or reject suggested memory changes before agents rely on them.",
                "Give context to AI",
                "Connect an agent",
                "Your work",
                "Use your own project",
                "Register an existing local folder so ADH can show and hand off context for it.",
                "Latest status",
                "Attention",
                "risks/questions",
                "Review queue",
            ...
            "/?lang=de": (
                ...
                "Wähle einen Weg: aktuellen Projektstand lesen, vorgeschlagene Änderungen prüfen oder Kontext für einen Agenten vorbereiten.",
                "Projekt verstehen",
                "Projektstand lesen",
                "Öffne den Projektstand mit letztem Bericht, Risiken, Fragen und geprüftem Gedächtnis.",
                "Menschliche Prüfung",
                "Akzeptiere oder verwerfe vorgeschlagene Änderungen, bevor Agenten sich darauf stützen.",
                "Kontext an KI geben",
                "Agent verbinden",
                "Deine Arbeit",
                "Eigenes Projekt nutzen",
                "Registriere einen bestehenden lokalen Ordner, damit ADH Kontext dafür anzeigen und übergeben kann.",
            ),
            "/projects/new": (
            ...
            "/projects/central-agent-data-hub-demo": (
                ...
                "Read latest status",
                "Start from the newest report so the work does not continue from stale assumptions.",
                "Check risks and questions",
                "Keep active risks and unanswered questions visible before work continues.",
                "Review suggestions",
                "Accept or reject suggested memory changes before agents rely on them.",
                ...
                "Browse all reviewed facts, decisions, risks, questions, and reports for this project.",
            ...
            (
                ...
                "Connect your agent",
                "Start here",
                "Choose how ADH reaches your agent",
                "Pick one path first.",
                "Choose your path",
                "Check it worked",
                "Copy text for chat",
                "Setup guide",
                "Set up one visible handoff",
                "ADH does not run the agent",
                "Agent setup guide",
                "Choose your agent",
                "Connect once when possible",
                "Check the next run",
                "Inspect the handoff",
                "what ADH is handing to the agent",
                "Connection status",
                "Recommended next step",
            ...
            "/projects/central-agent-data-hub-demo?lang=de": (
                ...
                "Letzten Stand lesen",
                "Beginne beim neuesten Bericht, damit die Arbeit nicht aus veralteten Annahmen weiterläuft.",
                "Risiken und Fragen prüfen",
                "Halte aktive Risiken und unbeantwortete Fragen sichtbar, bevor die Arbeit weitergeht.",
                "Vorschläge prüfen",
                "Akzeptiere oder verwerfe vorgeschlagene Gedächtnisänderungen, bevor Agenten sich darauf stützen.",
            ...
            (
                ...
                "Agent verbinden",
                "Hier starten",
                "Wähle, wie ADH deinen Agenten erreicht",
                "Wähle zuerst einen Weg.",
                "Weg auswählen",
                "Prüfen, ob es klappt",
                "Text für Chat kopieren",
                "Verbindungsstatus",
            ...
            (
                ...
                "Text für Chat kopieren",
                "Einrichtungsweg",
                "Eine sichtbare Übergabe einrichten",
                "ADH startet den Agenten nicht",
                "Agent auswählen",
                "Wenn möglich einmal verbinden",
