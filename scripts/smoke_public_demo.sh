    ...
    try:
        checks = {
            "/": (
                ...
                "Prepare the reviewed context before work starts.",
                "Review suggested changes",
                "Find reviewed memory",
                "Filter visible facts, decisions, risks, questions, reports, and relations.",
            ...
            "/projects/central-agent-data-hub-demo?lang=de": (
                "<html lang=\"de\">",
                "lokale Review-Oberfläche",
                "Aktive Projekte",
                "Projektaktionen",
                "ADH mit Agent nutzen",
                "Geprüftes Memory finden",
            ...
            "/inbox?lang=de": (
                "<html lang=\"de\">",
                "Review Inbox",
                "Vorgeschlagene Memory-Änderungen bleiben unbestätigt",
                "Nichts zu prüfen.",
