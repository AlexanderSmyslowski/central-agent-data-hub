...
2. Type into **Filter visible memory**
...
reviewed memory**, use **Filter visible memory**, understand that the filter
only searches visible reviewed memory, and still find **Use ADH with an
agent**.
